...
\begin{zad}[Wiktor Szymonek, Autor 2]
...
\begin{zad}(kolos) (Wiktor Szymonek,)
...
\begin{mdframed}
    ...
    Wówczas dla dowolnego $A,B \in \mathcal{F}$ zachodzi $1 \in A \cap B \implies A\cap B \ne \emptyset$ zatem $M$ jest przecinającą się rodziną.
...
\begin{mdframed}
    ...
    \[M = \left\{A\in M : 1 \notin A\right\}\]
    Wówczas dla dowolnego $A,B \in \mathcal{F}$ zachodzi $1 \notin A \cup B \implies A\cup B \ne [n]$
